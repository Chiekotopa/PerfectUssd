...
public class UssdService extends Thread {
    ...
    public Responses CheckCompteExpediteur(String phone) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=checker_compte_expediteur&Code_client=" + phone + "";
    ...
    public Responses CheckCompteDestinaire(String phoneExp, String phoneDest) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=checker_compte_destinataire&Code_clientExpediteur=" + phoneExp + "&Code_clientDestinataire=" + phoneDest + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses CheckSoldeTransfert(String solde, String phoneExp, String phoneDest) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=checker_solde_expediteur_transfert&Code_clientExpediteur=" + phoneExp + "&Code_clientDestinataire=" + phoneDest + "&Montant=" + solde + "";
        response = restTemplate.getForObject(url, Responses.class, response);
        return response;
    }
    ...
    public Responses validationTransfert(String solde, String phoneExp, String phoneDest, String securiteCode) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=validation_transfert_account_perfect_pay&Code_clientExpediteur=" + phoneExp + "&Code_clientDestinataire=" + phoneDest + "&Montant=" + solde + "&CodeSecurite=" + securiteCode + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses CheckCodeSecret(String phoneExp, String secretCode) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=affiche_solde_ussd&CodeClient=" + phoneExp + "&secret_code=" + secretCode + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses CheckListTransation(String phoneExp, String secretCode) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=liste_transaction_ussd&CodeClient=" + phoneExp + "&secret_code=" + secretCode + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses CheckAncienCode(String phoneExp, String secretCode) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=verifier_ancien_code_secret&CodeClient=" + phoneExp + "&secret_code=" + secretCode + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses CheckNouveauCode(String ancienCode, String newCode) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=verifier_nouveau_code_secret&ping_code=" + newCode + "&ancien_ping_code=" + ancienCode + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses updateCodeSecret(String ancienCode, String phoneExp, String repeadCode, String pingCode) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=Editer_code_secret&CodeClient=" + phoneExp + "&repeat_ping_code=" + repeadCode + "&ping_code=" + pingCode + "&ancien_ping_code=" + ancienCode + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses checkerCodeMarchant(String codeMarchand) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=checker_code_Marchand_usssd&CodeMarchand=" + codeMarchand + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses checkerCodeSecret2(String codeMarchand, String codeClient, String codeSecret) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=checker_code_Marchand_usssd_verrif&CodeMarchand=" + codeMarchand + "&CodeClient=" + codeClient + "&secret_code=" + codeSecret + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses checkSoldePaiment(String codeMarchand, String codeClient, Double montant) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=checker_solde_paiement_marchand&CodeMarchand=" + codeMarchand + "&CodeClient=" + codeClient + "&Montant=" + montant + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses MakePaimentMarchand(String codeMarchand, String codeClient, Double montant, String codeSecurite) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=paiement_marchand_ussd&Code_client=" + codeClient + "&CodeMarchand=" + codeMarchand + "&Montant=" + montant + "&CodeSecurite=" + codeSecurite + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses CheckCni(String Cni) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=Verification_CNI&NumeroCNI=" + Cni + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses CheckSexe(String Sexe) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=Verification_Sexe&Sexe=" + Sexe + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses CheckDate(String Date) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=Verification_DateNaissance&DateNaissance=" + Date + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses CheckContribuable(String numContribuable) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=Verification_NumeroContribuable&NumeroContribuable=" + numContribuable + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses CheckEmail(String email) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=Verification_Email&Email=" + email + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses ConfirmCodeSecret(String codeSecret, String codeRepead) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=Verification_Codes_Secrets&CodeSecret=" + codeSecret + "&CodeSecret_repeat=" + codeRepead + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses CreateAccountUssd(Sessionussd sessionUssd) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=create_account_ussd&Nom=" + sessionUssd.getNom() + "&Prenom=" + sessionUssd.getPrenom() + "&NumeroCNI=" + sessionUssd.getCni() + "&Telephone=" + sessionUssd.getMsisdn() + ""
    ...
    public Responses checkCodeSecretForNewAccount(String secretCode) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=Verification_CodeSecret&CodeSecret=" + secretCode + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses checkCompteExpediteurMenu(String tel) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=checker_compte_Expediteur_menu&Code_client=" + tel + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses validationRetraitAccountPerfectPay(String ClientExp, String ClientDest, Double montant, String codeSecurite) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=validation_retrait_account_perfect_pay&Code_clientExpediteur=" + ClientExp + "&Code_clientDestinataire=" + ClientDest + "&Montant=" + montant + "&CodeSecurite=" + codeSecurite + "";
        response = restTemplate.getForObject(url, Responses.class, response);

        return response;
    }

    public Responses check_CodeSecret(String phonedest, String codesecret) {
        Responses response = new Responses();
        headers.set(HttpHeaders.CONTENT_TYPE, "application/json");
        String boString = "";
        headers.set(HttpHeaders.ACCEPT, "application/json");
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=check_CodeSecret&indexe_users=" + phonedest + "&secret_code=" + codesecret + "";
        response = restTemplate.getForObject(url, Responses.class, response);

        return response;
    }

    public void create_transaction(Sessiontrans sessiontrans) {
        Responses response = new Responses();
        headers.set(HttpHeaders.CONTENT_TYPE, "application/json");
        String boString = "";
        headers.set(HttpHeaders.ACCEPT, "application/json");
    ...
    public Responses checkerCompteDestinataireAgent(String phoneExp, String phoneDest) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=checker_compte_destinataire_agent&Code_clientExpediteur=" + phoneExp + "&Code_clientDestinataire=" + phoneDest + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses checkerCompteDestinataireClientUSSD(String phoneExp, String phoneDest) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=checker_compte_destinataire_client_USSD&Code_clientExpediteur=" + phoneExp + "&Code_clientDestinataire=" + phoneDest + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses VerificationCheckingDepotCllientUSSSD(String phoneExp, String phoneDest, Double solde) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=Verification_Checking_depotCllient_USSSD&Code_clientExpediteur=" + phoneExp + "&Code_clientDestinataire=" + phoneDest + "&Montant=" + solde + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses Verification_Checking_agent_USSD(String phoneExp, String phoneDest, Double solde) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=Verification_Checking_agent_USSD&Code_clientExpediteur=" + phoneExp + "&Code_clientDestinataire=" + phoneDest + "&Montant=" + solde + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses validationDepotComptePerfectPayClientUSSD(String phoneExp, String phoneDest, Double solde, String codesecure) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=validation_depot_compte_PerfectPayClient_USSD&Code_clientExpediteur=" + phoneExp + "&Code_clientDestinataire=" + phoneDest + "&Montant=" + solde + "&CodeSecurite=" + codesecure + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses validation_depot_compte_agent_USSD(String phoneExp, String phoneDest, Double solde, String codesecure) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=validation_depot_compte_agent_USSD&Code_clientExpediteur=" + phoneExp + "&Code_clientDestinataire=" + phoneDest + "&Montant=" + solde + "&CodeSecurite=" + codesecure + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses View_comissions_revendeurs_journaliere(String phone, String secretCode) {
        ...
        String url = "https://api.kakotel.com/api-perfectpay.php?action=View_comissions_revendeurs_journaliere&CodeClient=" + phone + "&secret_code=" + secretCode + "";
        response = restTemplate.getForObject(url, Responses.class, response);
    ...
    public Responses Valide_Transfert_walet_MNO_USSD(Sessionussd s) {
     ...
     public Responses Solde_transfert_walet_Banque_USSD(Sessionussd s) {
        ...
        headers.set(HttpHeaders.ACCEPT, "application/json");
        HttpEntity<Responses> entity = new HttpEntity<>(response, headers);
        String url = "https://api.kakotel.com/api-gimacpay_mobile.php?action=Solde_transfert_walet_Banque_USSD&Code_clientExpediteur="
                +s.getMsisdn().substring(3)+"&Code_clientDestinataire="+s.getDestinataire()+"&Montant="+s.getMontant()+"&WalletDestinataire="+s.getWallet()+"";
        response = restTemplate.getForObject(url, Responses.class, response);
        return response;
    }
      ...
      public Responses Valide_Transfert_walet_Banque_USSD(Sessionussd s) {
        ...
        headers.set(HttpHeaders.ACCEPT, "application/json");
        HttpEntity<Responses> entity = new HttpEntity<>(response, headers);
        String url = "https://api.kakotel.com/api-gimacpay_mobile.php?action=Valide_Transfert_walet_Banque_USSD&Code_clientExpediteur="
                +s.getMsisdn().substring(3)+"&Code_clientDestinataire="+s.getDestinataire()+"&Montant="+s.getMontant()
                +"&WalletDestinataire="+s.getWallet()+"&ReferenceTransaction="+s.getReference()+"&CodeSecurite="+s.getCodesecret()+"";
        response = restTemplate.getForObject(url, Responses.class, response);
        return response;
    }
      
       public Responses Solde_paiement_Marchand_USSD(Sessionussd s) {
        Responses response = new Responses();
        headers.set(HttpHeaders.CONTENT_TYPE, "application/json");
        headers.set(HttpHeaders.ACCEPT, "application/json");
        HttpEntity<Responses> entity = new HttpEntity<>(response, headers);
        String url = "https://api.kakotel.com/api-gimacpay_mobile.php?action=Solde_paiement_Marchand_USSD&Code_clientExpediteur="+s.getMsisdn().substring(3)+
                "&CodeMarchand="+s.getDestinataire()+"&Montant="+s.getMontant()+"&WalletMarchand="+s.getWallet()+"";
        response = restTemplate.getForObject(url, Responses.class, response);
        return response;
    }
       
       
        public Responses Valide_paiement_Marchand_USSD(Sessionussd s) {
        Responses response = new Responses();
        headers.set(HttpHeaders.CONTENT_TYPE, "application/json");
        headers.set(HttpHeaders.ACCEPT, "application/json");
        HttpEntity<Responses> entity = new HttpEntity<>(response, headers);
        String url = "https://api.kakotel.com/api-gimacpay_mobile.php?action=Valide_paiement_Marchand_USSD&Code_clientExpediteur="+s.getMsisdn().substring(3)+"&CodeMarchand="+s.getDestinataire()+"&Montant="+s.getMontant()+"&WalletMarchand="+s.getWallet()+
                "&ReferenceTransaction="+s.getReference()+"&CodeSecurite="+s.getCodesecret()+"";
        response = restTemplate.getForObject(url, Responses.class, response);
        return response;
    }
